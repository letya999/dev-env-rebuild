...
printf '\nPython base runtime check:\n'
if command -v python3 >/dev/null 2>&1; then
  printf '[OK] python3 still present as expected: %s\n' "$(python3 --version 2>&1)"
else
  printf '[WARN] python3 not found. This is unusual on Ubuntu and should be investigated.\n'
fi
